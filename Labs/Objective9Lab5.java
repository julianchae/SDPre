...
public class Objective9Lab5{
  public static void main(String[]args){
    ...
    while(keepGoing){
      ...
      switch (choice){
        ...
        break;
        case 3:
        answer = findTax(num1, num2);
        System.out.println("The amount of tax to be collected from a purchase of "+num1+" and "+num2+" is "+ answer);
        break;
        case 4:
  ...
  public static double findTax(double c, double d){
    double tax = (c+d)*0.0831;
    return tax;
  }
